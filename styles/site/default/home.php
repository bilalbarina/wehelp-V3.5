                    ...
                    <div class="ask_a_Question_button">
                        <?php if (!(user())): ?>
                            <a href="javascript:popup_switch('login')">
                                    <i class="fa fa-ticket"></i> <?php echo lang('global_Submit_a_Ticket') ?>
                            </a>
                        <?php else: ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <div class="ask_a_Question_button">
                    <?php if (!(user())): ?>
                        <a href="javascript:popup_switch('login')"><i class="fa fa-ticket"></i> <?php echo lang('global_Submit_a_Ticket') ?></a>
                    <?php else: ?>
