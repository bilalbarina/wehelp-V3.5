<div style="direction: <?php echo lang('dir') ?>;color: #333; width: 60%; margin: auto; border: 1px solid #dedede; font-size: 16px;font-family: sans-serif;">
    ...
    <div style="padding-bottom: 15px; margin-bottom: 15px; padding: 20px;">
        ...
        <p style="line-height: 28px;">
            <?php echo lang('global_You_requested_to_receive_the_password_for_account') ?>: <?php echo $user->username ?> <?php echo lang('global_please_check_below_your_information') ?>:<br />
            <br>
            <b><?php echo lang('global_Username') ?>:</b> <?php echo $user->email ?><br />
