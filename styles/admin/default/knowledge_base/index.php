...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo lang('global_Knowledge_Base') ?></h3>
        <div class="panel-options">
            <a href="<?php echo site_url('admin/knowledge_base/manage'); ?>" class="btn btn-secondary btn-sm" style="color:#fff"><i class="fa fa-plus-square" aria-hidden="true"></i> <?php echo lang('global_add_new_record') ?></a>
        </div>
    </div>
            ...
            <table class="table table-bordered table-striped" id="datatable_">
                <thead>
                    <tr>
                        ...
                        <th><?php echo lang('global_Question') ?></th>
                ...
                <tbody class="middle-align">
                    <?php foreach ($items as $item): ?>
                        <tr id="<?php echo $item->faq_id ?>">
                            ...
                            <td>
                                <a href="<?php echo site_url('admin/knowledge_base/manage/' . $item->faq_id); ?>" class="btn btn-orange btn-sm">
...
<script type="text/javascript">
    $(".remove").click(function () {
        ...
        {
            $.ajax({
                url: '<?php echo site_url() ?>admin/knowledge_base/delete/' + id,
                type: 'DELETE',
                error: function () {
